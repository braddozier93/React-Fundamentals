    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <p>Below are some of the resources that we used throughuot this app. Note: You'll have one challenge where you'll be asked to make this page better.</p>
                <ul>
                    <li>
                        <a href="http://react.js.org/docs/getting-started.html" target="_blank">
                            The Official Docs
                        </a>
                    </li>
                    <li>
