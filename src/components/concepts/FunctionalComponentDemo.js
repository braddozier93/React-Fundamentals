        ...
        <Container className="main">
            <Row>
                <Col xs="12">
                    ...
                    <p>Functional components are teh primary tool in React to build a small, modular piece of your page...</p>
                    <dl>
                        <dt>Can use state</dt>
                        <dd>With the 'useState' hook, functional components can now n=both render a display to the page and update the information to be shown</dd>
                        <dt>No 'this' keyword</dt>
                        <dd>Older class components use 'this', functional components have no 'this' object.</dd>
                        <dt>Can use effects</dt>
                        <dd>With the 'useEffect' hook, functional components can perform side effeects with any props or state changes.</dd>
                        <dt>return()</dt>
