...
const key = 't8xXaTGc9LTGXkivYkk10yjb5GGAaTeb';
        ...
        <div className="main">
            <div className="mainDiv">
                <form onSubmit={(e) => handleSubmit(e)}>
                    <span>Enter single search term (required): </span>
                    ...
                    <input type="date" name="startDate" pattern="[0-9]{8}" onChange={(e) => setEndDate(e.target.value)} />
                    <br />
